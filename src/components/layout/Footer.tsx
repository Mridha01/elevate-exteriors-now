      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-ink-muted">
            Premium roofing, siding, gutters and exterior solutions built to last. Licensed, insured,
            and trusted by homeowners for over {company.yearsExperience} years.
          </p>
        ...
        <div>
          <h4 className="font-display text-sm font-700 uppercase tracking-wider text-white">Quick Links</h4>
        ...
        <div>
          <h4 className="font-display text-sm font-700 uppercase tracking-wider text-white">Services</h4>
          <ul className="mt-4 space-y-2.5 text-sm text-ink-muted">
        ...
        <div>
          <h4 className="font-display text-sm font-700 uppercase tracking-wider text-white">Contact</h4>
          <ul className="mt-4 space-y-3 text-sm text-ink-muted">
            ...
            <li>
              <a href={company.phoneHref} className="flex items-center gap-2.5 hover:text-primary-glow">
                <Phone className="size-4 shrink-0 text-primary-glow" /> {company.phoneDisplay}
              </a>
            </li>
            <li>
              <a href={`mailto:${company.email}`} className="flex items-center gap-2.5 hover:text-primary-glow">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-5">
          <p className="text-xs text-ink-muted">
            <span className="font-600 text-white/80">Service Areas:</span> {serviceAreas.join(" · ")}
          </p>
        </div>
        <div className="border-t border-white/10">
