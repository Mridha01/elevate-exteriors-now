  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-[1.1em] [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-[var(--gold)] text-ink shadow-card hover:-translate-y-0.5 hover:brightness-105",
        "outline-light":
          "border border-white/40 bg-white/5 text-white backdrop-blur-sm hover:bg-white/15 hover:border-white/70",
        ink: "bg-ink text-ink-foreground shadow-card hover:-translate-y-0.5 hover:brightness-125",
      },
      size: {
