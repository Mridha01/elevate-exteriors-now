...
const steps = [
  {
    icon: Search,
    title: "Inspection",
    text: "A thorough, no-obligation roof and exterior inspection with honest findings.",
  },
  {
    icon: FileText,
    title: "Estimate",
    text: "A clear, itemized estimate with options — no pressure, no hidden fees.",
  },
  {
    icon: Layers,
    title: "Material Selection",
    text: "Choose premium materials and colors with expert guidance to match your home.",
  },
  {
    icon: Hammer,
    title: "Installation",
    text: "Certified crews complete the work efficiently with disciplined craftsmanship.",
  },
  {
    icon: ClipboardCheck,
    title: "Final Inspection",
    text: "A detailed walkthrough, magnetic nail sweep, and spotless clean-up.",
  },
];
          ...
          {steps.map((s, i) => (
            <Reveal key={s.title} delay={i * 90}>
              <div className="relative flex h-full flex-col items-start gap-4 rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
                <span className="font-display text-5xl font-800 text-white/10">
